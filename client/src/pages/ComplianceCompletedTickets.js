...
import { ArrowLeftIcon, EyeIcon, XMarkIcon, ChevronLeftIcon, ChevronRightIcon, ArrowDownTrayIcon } from '@heroicons/react/24/outline';
...
const ComplianceCompletedTickets = () => {
  ...
  const fetchTickets = () => {
    ...
    api.get('/compliance/dashboard')
      .then(res => {
        ...
        // Filter only completed tickets using effective status logic
  ...
  return (
    <div className="flex flex-col flex-1 min-h-0 space-y-3">
      ...
      <PageHeader title="Completed Tickets">
          ...
          <table style={{ minWidth: '1400px' }} className="w-full">
            <thead style={{ backgroundColor: '#ededed' }} className="border-b border-gray-200">
              <tr>
                ...
                <th className="px-4 py-4 text-left text-sm font-medium text-gray-700 sticky top-0 z-10 cursor-pointer select-none" style={{ backgroundColor: '#ededed' }} onClick={() => handleSort('completed_at')}>Completed By<SortIcon col="completed_at" /></th>
                <th className="px-4 py-4 text-left text-sm font-medium text-gray-700 sticky top-0 z-10 cursor-pointer select-none" style={{ backgroundColor: '#ededed' }} onClick={() => handleSort('completed_at')}>Completed On<SortIcon col="completed_at" /></th>
            ...
            <tbody className="divide-y divide-gray-100">
              {loading ? (
                <tr><td colSpan="15" className="px-4 py-6 text-center text-gray-500">Loading...</td></tr>
              ) : paginated.length === 0 ? (
                <tr><td colSpan="15" className="px-4 py-6 text-center text-gray-500">No completed tickets found</td></tr>
              ) : (
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <div className="px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm">
                    <span className="inline-flex px-2 py-0.5 text-xs font-medium rounded-full whitespace-nowrap bg-green-100 text-green-700">
                      Completed
                    </span>
                  </div>
                </div>
...
export default ComplianceCompletedTickets;