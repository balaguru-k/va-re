...
const ComplianceInProgressTickets = () => {
  ...
  const fetchTickets = () => {
    ...
    api.get('/compliance/dashboard')
      .then(res => {
        ...
        // Filter only in progress tickets using effective status logic
  ...
  return (
    <div className="flex flex-col flex-1 min-h-0 space-y-3">
      ...
      <PageHeader title="In Progress Tickets">
          ...
          <table style={{ minWidth: '1400px' }} className="w-full">
            ...
            <tbody className="divide-y divide-gray-100">
              {loading ? (
                ...
                <tr><td colSpan="13" className="px-4 py-6 text-center text-gray-500">No in progress tickets found</td></tr>
              ) : (
                ...
                <div>
                  ...
                  <div className="px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm">
                    {(() => {
                      ...
                      return displayStatus ? (
                        <span className="inline-flex px-2 py-0.5 text-xs font-medium rounded-full whitespace-nowrap bg-blue-100 text-blue-700">
                          {displayStatus}
                        </span>
                      ) : '-';
                    })()}
...
export default ComplianceInProgressTickets;